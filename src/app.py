...
activities = {
    ...
    "Music Ensemble": {
        "description": "Perform instrumental and vocal music in an ensemble setting",
    ...
    "Debate Club": {
        ...
        "max_participants": 18,
        "participants": ["christopher@mergington.edu", "jessica@mergington.edu"]
    },
    "Science Club": {
...
def signup_for_activity(activity_name: str, email: EmailParam):
...
def unregister_from_activity(activity_name: str, email: EmailParam):
